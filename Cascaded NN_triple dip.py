...
if (start_epoch==1):
    ...
    start_epoch=1 
    num_epoch=1
    current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_dualband_01.pth" 
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_dualband_01.pth" 
