# -*- coding: utf-8 -*-
"""single dip_JULIA SUMMERCAMP PYTHON CODE

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gpVnVIk8__hnH6UlwuULYX-8bjkQ8hzN
"""
...
#page 3203 sinf band targe 
para=torch.tensor([20.45,1.46,0.94,0.92]).float().cuda()    
...
sinf_full=torch.tensor(amplitude_para_np).cuda() #calculated target spectrum from the parameters on page 3202
...
if (start_epoch==1):
    ...
    start_epoch=1 
    num_epoch=1
    current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_singledip.pth" 
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_singledip.pth" 
...
num_epoch=50000 # number of iterations
import time
start = time.time()
...
#Apply the best trained model to the sinf band data
#current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_sinfband_02.pth" 
best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_singledip.pth" 
loss_func=nn.MSELoss()
DNN = matafilter().cuda()    #define model
...
r2=np.corrcoef(sinf_pred_np, sinf_full_np)[0,1]
