# -*- coding: utf-8 -*-
"""single band _2_JULIA SUMMERCAMP PYTHON CODE
...
if (start_epoch==1):
    ...
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_sinfband_02.pth" 
...
num_epoch=100000 # number of iterations
import time
start = time.time()
