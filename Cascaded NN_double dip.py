...
para=torch.tensor([21.98,1.48,1.45,0.68]).float().cuda()    
...
plt.title('Calculated target spectrum from parameters=[21.98,1.48,1.45,0.68] \n From figure 6')
...
if (start_epoch==1):
    ...
    start_epoch=1 
    num_epoch=1
    current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_doubledip.pth" 
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_doubledip.pth" 
