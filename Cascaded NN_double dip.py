...
Original file is located at
    https://colab.research.google.com/drive/1nocNa64Mm8xz1D8ia9VIAM4f2dv7P2uE
"""
...
para=torch.tensor([20.92,1.49,1.48,0.58]).float().cuda()    
...
plt.title('Calculated target spectrum from parameters=[20.92,1.49,1.48,0.58] \n From figure 6')
...
if (start_epoch==1):
    ...
    start_epoch=1 
    num_epoch=1
    current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_dualband_04.pth" 
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_dualband_04.pth" 
...
for i in range(1): 
        ...
        plt.title('dual-band_4 target spectra vs designed spectra  \n'+'lr='+str(lr)+', num_epoch='+str(num_epoch) )
