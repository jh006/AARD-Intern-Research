# -*- coding: utf-8 -*-
"""DNN model_single band

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1EPyu3YCB5_wd0luHKnxcO0xHzDL3eZ-O
"""
...
if (start_epoch==1):
    ...
    start_epoch=1 
    num_epoch=1
    current_checkpoint="/content/drive/MyDrive/current_checkpoint_DNN_sinfband_01.pth" 
    best_checkpoint="/content/drive/MyDrive/best_checkpoint_DNN_sinfband_01.pth" 
...
num_epoch=500000 # number of iterations
import time
start = time.time()
...
for i in range(1): 
        ...
        plt.title('target spectra vs designed spectra  \n'+'single band_1, lr='+str(lr)+', num_epoch='+str(num_epoch) )
